...
def main():
    ...
    User_url = 'http://www.mafengwo.cn/u/lalafc/review.html'
    # pagenum = str(20)
    # Curr_url = 'http://www.mafengwo.cn/home/ajax_review.php?act=loadList&filter=0&offset=20&limit=20&uid=36556965&sort=1'
    spotList = []
    scoreList = []
    reviewList = []
    timeList = []
